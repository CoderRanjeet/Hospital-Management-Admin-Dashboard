...
namespace HospitalManagementAdmin
{
    public partial class AddDoctor : System.Web.UI.Page
    {
        ...
        protected void BtnAddDoctor_ServerClick(object sender, EventArgs e)
        {
            ...
            if(Td.DocId > 0)
            {
                ShowMessage("Welcome", "Dashboard", MessageType.success);
                Clear();
            }
            else
            {
                ShowMessage("Welcome", "Dashboard", MessageType.warning);
            }
        }
