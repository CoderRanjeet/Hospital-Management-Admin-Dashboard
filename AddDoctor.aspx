<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddDoctor.aspx.cs" Inherits="HospitalManagementAdmin.AddDoctor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main id="main" class="main">
        <div class="row mb-4">
            <div class="col-lg-12">
                <h4 class="page-title text-center text-decoration-underline">Add Doctor</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
        ...
        <div class=" mt-4 text-center">
            <button class="btn btn-primary submit-btn" id="BtnAddDoctor" runat="server" onserverclick="BtnAddDoctor_ServerClick">Add Doctor</button>
        </div>
    </main>
